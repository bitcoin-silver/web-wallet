...
class WalletService {
  ...
  Future<Map<String, dynamic>> sendTransaction(
    ...
    return {
      'success': false,
      'message': 'Insufficient funds. Available balance: ${inputSum.toStringAsFixed(8)} BTCS. If you have recent deposits, please wait approximately 20 minutes for confirmation.'
    };
  }
